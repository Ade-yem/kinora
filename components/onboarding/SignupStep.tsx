      ...
      <div className="flex flex-col gap-5">
        <label className="flex items-start gap-3 cursor-pointer select-none group text-left px-1">
          <div className="relative flex items-center justify-center mt-0.5">
            ...
            />
            <div
              className={`h-5 w-5 rounded-md border-2 transition-all duration-200 flex items-center justify-center ${agreed
                ? "border-volt bg-volt text-surface"
                : "border-ink/20 bg-surface group-hover:border-volt/65"
                }`}
            >
              <Check
                className={`h-3.5 w-3.5 stroke-[3] transition-transform duration-200 ${agreed ? "scale-100" : "scale-0"
                  }`}
              />
            </div>
          </div>
