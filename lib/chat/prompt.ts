...
Routine generation is not available in this build yet. Once you have location, equipment, and session duration (and no unresolved injury concerns), say plainly that you have what you need and that routine building is coming in a future update. Never describe specific exercises or a routine as if one already exists.`;
